            ...
            sheetClasses: [
                {
                    ...
                    fieldConfigs: [
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-key-actor input[type="text"]`,
                            defaultPath: 'system',
                            showButton: true,
                            allowHotkey: true,
                        ...
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-key-targeted_actor input[type="text"]`,
                            defaultPath: 'system',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.OWNING_ACTOR_DATA,
                        ...
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-key-test_all input[type="text"]`,
                            defaultPath: '',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.CUSTOM,
                            customDataGetter: AutocompleteInlineHooksFlow.keyGetterTestData,
                        },
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-key-test_item input[type="text"]`,
                            defaultPath: '',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.CUSTOM,
                        ...
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-key-modifier input[type="text"]`,
                            defaultPath: '',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.CUSTOM,
                            customDataGetter: AutocompleteInlineHooksFlow.keyGetterModifiersData,
                        },

                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-value-actor input[type="text"]`,
                            defaultPath: 'system',
                            inlinePrefix: '@',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.CUSTOM,
                            customDataGetter: AutocompleteInlineHooksFlow.valueGetterActor,
                        },
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-value-targeted_actor input[type="text"]`,
                            defaultPath: '',
                            inlinePrefix: '@',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.CUSTOM,
                            customDataGetter: AutocompleteInlineHooksFlow.valueGetterTargetedActorData,
                        },
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-value-test_all input[type="text"]`,
                            defaultPath: 'system',
                            inlinePrefix: '@',
                            showButton: true,
                            allowHotkey: true,
                            dataMode: DATA_MODE.CUSTOM,
                            customDataGetter: AutocompleteInlineHooksFlow.valueGetterTestData,
                        },
                        {
                            selector: `.tab[data-tab="effects"] .autocomplete-value-test_item input[type="text"]`,
                            defaultPath: 'system',
                            inlinePrefix: '@',
                            showButton: true,
                            allowHotkey: true,
