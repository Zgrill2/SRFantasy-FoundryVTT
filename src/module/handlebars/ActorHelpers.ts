...
export const registerActorHelpers = () => {
    ...
    Handlebars.registerHelper(
        'showWoundModifier',
        (box: number, painTolerance: number, woundBoxesThreshold: number): boolean => {
    ...
    Handlebars.registerHelper(
        'woundModifier',
        (box: number, painTolerance: number, woundBoxesThreshold: number): number => {
     ...
     */
    Handlebars.registerHelper(
        'calcModificationCategorySlots',
        (items: [SR5Item], modificationCategory: ModificationCategoryType): number => {
