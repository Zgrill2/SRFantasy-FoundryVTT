...
export async function onManageItemActiveEffect(event: MouseEvent) {
    ...
    if (effectUuidIsNestedItem(uuid))
        return ui.notifications.error(
            "Effects on nested items can't be managed. Move the item to the sidebar to manage.",
        );
 ...
 */
export function prepareSortedItemEffects(
    document: SR5Actor | SR5Item,
    options: ApplicableItemEffectOptions = {},
): Shadowrun.AllEnabledEffectsSheetData {
 ...
 */
export function* allApplicableDocumentEffects(
    document: SR5Actor | SR5Item,
    options: ApplicableDocumentEffectOptions = {},
) {
